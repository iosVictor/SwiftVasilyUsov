...
//  Right on target
//
//  Created by Victor Kimpel on 18.12.22.
//
...
// Структура будет использоваться совместно с дженериком SecretValue, в котором тип T должен соответствовать протоколу Equatable
...
struct Color: ColorProtocol, Equatable {
    ...
    func getByHEXString() -> String {
        // Переводим данные об интенсивности каналов в 16-тиричную системы счисления
    ...
    func getByUIColor() -> UIColor {
        ...
        // Исходя из этого нам необходимо преобразовать имеющиеся значения от 0.0 до 1.0
